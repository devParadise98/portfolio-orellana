          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div>
              ...
              <p className="text-gray-600 mb-8">
                I enjoy working in collaborative and dynamic environments, providing solutions that drive efficiency and innovation. With a proactive approach and commitment to quality, I ensure the fulfillment of objectives and continuous improvement.
              </p>
